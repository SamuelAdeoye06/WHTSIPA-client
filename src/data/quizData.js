...
export const QUIZ_DATA = {
  instagram_hack: {
    ...
    questions: [
      ...
      { q: 'Instagram 5 of 5', prompt: 'Identify the legitimate Instagram security alert vs a fake hack attempt.', correct: 1, options: ['Email: "Your password was changed, click to undo" from random domain', 'In-app notification: "We detected a new login from Lagos, Nigeria"', 'DM: "We are Instagram support, send us your password"', 'Pop-up asking you to verify your account externally'] },
    ]
  },
  facebook_hack: {
    title: 'Facebook Hack',
  ...
  tax_refund_scam: {
    ...
    questions: [
      ...
      { q: 'Tax Refund 4 of 5', prompt: 'What information should you never share in response to an unsolicited tax refund offer?', correct: 2, options: ['Your city of residence', 'Your employer name', 'Your NIN, bank account, or OTP', 'Your email address'] },
  ...
  fake_job: {
    ...
    questions: [
      ...
      { q: 'Fake Job 3 of 5', prompt: 'An employer asks for your NIN, bank details, and passport before any formal offer. What do you do?', correct: 1, options: ['Provide everything — it\'s for HR onboarding', 'Verify the company is real before sharing any sensitive documents', 'Provide only your bank details', 'Share your passport but not NIN'] },
  ...
  identity_theft: {
    ...
    questions: [
      ...
      { q: 'Identity Theft 2 of 5', prompt: 'Which piece of information is most valuable to an identity thief?', correct: 2, options: ['Your Instagram username', 'Your favorite restaurant', 'Your NIN + date of birth + address together', 'Your first name and email'] },
